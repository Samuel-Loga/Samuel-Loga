...
- 🔐 **Securing systems, applications, and networks** to defend against evolving cyber threats.
- 🤖 **Exploring AI and machine learning** to build data-driven models that solve real-world challenges.
...
<!--
**Samuel-Loga/Samuel-Loga** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
